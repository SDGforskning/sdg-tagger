...
def test_are_terms_in_input_text(mocker_pattern_search_boolean, mocker_prepare_regex_search_termlist):
    # Arrange
...
@mock.patch('src.helpers.prepare_regex_search_termlist')
@mock.patch('src.helpers._pattern_search_boolean')
def test_are_terms_in_input_text_calls_pattern_search_boolean(mocker_pattern_search_boolean, mocker_prepare_regex_search_termlist):
    # Arrange
    mocker_prepare_regex_search_termlist.side_effect = [
        ('(?:ONE|Two)', 'Text with UPPERCASE'), 
        ('(?:three|four)', 'text with uppercase')
    ...
    # Assert
    mocker_pattern_search_boolean.assert_has_calls(expected_calls_pattern_search_boolean)
...
@mock.patch('src.helpers.prepare_regex_search_termlist')
@mock.patch('src.helpers._pattern_search_boolean')
def test_are_terms_in_input_text_calls_prepare_regex_search_termlist(mocker_pattern_search_boolean, mocker_prepare_regex_search_termlist):
    mocker_prepare_regex_search_termlist.side_effect = [
        ('(?:ONE|Two)', 'Text with UPPERCASE'), 
        ('(?:three|four)', 'text with uppercase')
    ]
    ...
    # Assert
    mocker_prepare_regex_search_termlist.assert_has_calls(expected_calls_prepare_regex_search_termlist)
